        ...
        this.shadowRoot.innerHTML = `
            ...
            <nav class="navbar">
                <div class="container">
                    ...
                    <ul class="nav-links">
                        <li><a href="/public/index.html" class="active">Inicio</a></li>
                        <li><a href="/public/pages/simulador.html">Simulador</a></li>
                        <li><a href="/public/pages/herramientas.html">Herramientas</a></li>
                        <li><a href="/public/pages/aprende.html">Aprende</a></li>
